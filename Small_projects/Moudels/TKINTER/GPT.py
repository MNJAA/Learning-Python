...
from qs import GPT, Example_questions_form  # Import your questions from qs.py
...
class Quiz:
    def __init__(self, root, questions):
        ...
        self.image_label = tk.Label(root, bg="#2E3440")
        ...
        self.back_button = tk.Button(self.button1_frame, text="Back", command=self.go_back, bg="#5E81AC", fg="black",
                                     font=("Times new roman", 16), activebackground="#ffd700")
        self.back_button.pack(side="left", padx=20)
        self.submit_button = tk.Button(self.button1_frame, text="Submit", command=self.submit_answer, bg="#5E81AC",
                                       fg="black", font=("Times new roman", 16), activebackground="#ffd700")
    ...
    def show_question(self):
        ...
        try:
            ...
            img = img.resize((400, 300))  # Resize the image if necessary
            img_tk = ImageTk.PhotoImage(img)
            self.image_label.config(image=img_tk)
            self.image_label.image = img_tk  # Keep a reference to avoid garbage collection
        except Exception as e:
            print(f"Error loading image: {e}")
            self.image_label.config(text="Image not found", fg="red")
...
if __name__ == "__main__":
    root = tk.Tk()
    root.title("MCQ Quiz with Images")
